...
# Before proceeding, I need to change the the class of avg canopy to numeric - it was matrix before
neighborhoods <- neighborhoods %>% mutate(avg_canopy = as.numeric(avg_canopy))
